...
continueBtn.onclick = () => {
    ...
    loadProgress(); // data load from localStorage
...
function loadProgress() {
    if (localStorage.getItem('queCount') !== null) {
        queCount = parseInt(localStorage.getItem('queCount'));
        queNumb = parseInt(localStorage.getItem('queNumb'));
        userScore = parseInt(localStorage.getItem('userScore'));
        timeValue = parseInt(localStorage.getItem('timeValue'));
...
// random background color genarate function
function genaretBack() {
...
function startTimer(time) {
    ...
    function timer() {
        ...
        // if (time < 4) {
        //     removeBackgroundColor('fivesecondcolor');
        //     addBackgroundColor('dangercolor');
        // }
        // if (time < 3) {
        //     removeBackgroundColor('dangercolor');
        //     addBackgroundColor('fivesecondcolor');
        // }
        // if (time < 2) {
        //     removeBackgroundColor('fivesecondcolor');
...
function removeBackgroundColor(removeBackgroundclass) {
    ...
    header.style.backgroundColor = removeBackgroundclass
    section.style.backgroundColor = removeBackgroundclass
    quizBox.style.backgroundColor = removeBackgroundclass
}
...
function addBackgroundColor(addbackgroundclass) {
    ...
    header.style.backgroundColor = addbackgroundclass
    section.style.backgroundColor = addbackgroundclass
    quizBox.style.backgroundColor = addbackgroundclass
}